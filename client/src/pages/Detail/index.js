    ...
    return (
        <AppLayout>
            <MainSection>
                {media &&
                    <div className="sidebar">
                        <div className="sidebar__background">
                            <img className="sidebar__img-bg" src={`https://image.tmdb.org/t/p/original${media.backdrop_path}`} alt={media.title + "wallpaper"} />
                                    ...
                                    <div className="sidebar__poster">
                                        <div className="sidebar__poster-container">
                                            <div className="sidebar__card">
                                                <img className="sidebar__card-img" src={`https://image.tmdb.org/t/p/w500${media.poster_path}`} alt={media.title} />
                ...
                {activePlayerVideo && <VideoPlayer typeMedia={typeMedia} mediaData={media} handleExit={handleExitVideoPlayer} />}
            </MainSection>
        </AppLayout>
    )
}
