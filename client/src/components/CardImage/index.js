...
const CardImage = () => {
    ...
    return (
        <div className="card-image">
            <img className="card-image__image" src="https://image.tmdb.org/t/p/original/a2fmufY8h0SirNKt37yprZdf7xi.jpg" alt="ImageCard" />
            <div className="card-image__button" role="button">
